...
<div id="show-dataset" class="content scaffold-show" role="main">
    ...
    <ol class="property-list dataset">
        ...
        <g:if test="${datasetInstance?.dataFile}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="dataFile-label"><g:fieldValue bean="${datasetInstance}"
                                                                                            field="dataFile"/></span>
        ...
        <g:if test="${datasetInstance?.description}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${datasetInstance}"
    ...
    <g:form>
        <fieldset class="buttons">
            ...
            <g:link class="edit" action="edit" id="${datasetInstance?.id}"><g:message code="default.button.edit.label"
                                                                                      default="Edit"/></g:link>
